<template>
    <div 
        ...
        class="bg-white inline-block rounded hover:shadow-[0_0_10px_3px_rgba(0,0,0,0.15)] w-full h-full"
    >
    <NuxtLink :to="`/item/${product.id}`">
        <img class="rounded-t w-full object-cover" :src="product.url">
        ...
        <div id="ProductDetails">
            ...
            <div class="flex items-center gap-1 px-1 relative -top-1">
                ...
                <span class="bg-[#f5f5f5] border text-[#c08562] text-[9px] font-semibold px-1.5 rounded-sm">To Selling</span>
            </div>
